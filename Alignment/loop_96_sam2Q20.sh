...
do
  ...
  if (($alternate==0))
      then
        echo "analysis/sam2Q20.py"$fermon_ref$q20_output
        python analysis/sam2Q20.py $fermon_ref $samfile $q20_output
      else
        echo "analysis/sam2Q20.py"$MO_ref$q20_output
        python analysis/sam2Q20.py $MO_ref $samfile $q20_output
  fi
done
